/**
 * NeuralDoc File Upload Component - Advanced Document Processing Interface
 * 
 ...
 * drag-and-drop support, and seamless integration with NeuralDoc processing pipeline.
 */
export function FileUpload({ onFileUpload, onUrlUpload, uploading = false }: FileUploadProps) {
   ...
   * by the NeuralDoc document analysis pipeline.
   */
